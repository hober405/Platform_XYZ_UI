    ...
    m_rootEntity(rootEntity)
{
    ...
    scale = 10;
    // xyz shape data
    Qt3DExtras::QCylinderMesh *x_cylinder = new Qt3DExtras::QCylinderMesh();
    ...
    Qt3DExtras::QPhongMaterial *x_cylinderMaterial = new Qt3DExtras::QPhongMaterial();
    ...
    // xyz shape data
    Qt3DExtras::QCylinderMesh *y_cylinder = new Qt3DExtras::QCylinderMesh();
    ...
    Qt3DExtras::QPhongMaterial *y_cylinderMaterial = new Qt3DExtras::QPhongMaterial();
    ...
    // xyz shape data
    Qt3DExtras::QCylinderMesh *z_cylinder = new Qt3DExtras::QCylinderMesh();
    ...
    Qt3DExtras::QPhongMaterial *z_cylinderMaterial = new Qt3DExtras::QPhongMaterial();
    ...
    // data shape data
    d_cylinder = new Qt3DExtras::QCylinderMesh();
    ...
    d_cylinderMaterial = new Qt3DExtras::QPhongMaterial();
    ...
    // Sphere shape data
    d_sphereMesh = new Qt3DExtras::QSphereMesh();
    ...
    d_sphereMaterial = new Qt3DExtras::QPhongMaterial;
